...
void PointCloudXyzrgbNodelet::connectCb()
{
  ...
  else if (!sub_depth_.getSubscriber())
  {
    ...
    sub_depth_.subscribe(*depth_it_, "/camera/depth_registered/image_rect",       1, hints);
...
PLUGINLIB_DECLARE_CLASS (gambit_perception, point_cloud_xyzrgb, gambit_perception::PointCloudXyzrgbNodelet, nodelet::Nodelet);
